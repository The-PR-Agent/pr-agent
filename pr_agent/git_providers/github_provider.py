...
class GithubProvider(GitProvider):
    ...
    def _resolve_app_login(self) -> str:
        ...
        except (GithubException, RequestException, AttributeError, KeyError, ValueError) as e:
            # ValueError: a malformed configured private key surfaces from the JWT layer.
    ...
    def resolve_comment_thread(self, comment_id: int) -> bool:
        ...
        try:
            ...
            return True
        except (GithubException, RequestException, ValueError, KeyError, TypeError) as e:
