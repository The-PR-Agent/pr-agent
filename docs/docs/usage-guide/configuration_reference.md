...
| `inline_key_issues` | false | Publish each review finding as an inline comment where the provider can verify inline-comment publication (GitHub, Bitbucket, Azure DevOps, GitLab). |
| `extra_instructions` | "" |  |
| `num_max_findings` | 3 |  |
